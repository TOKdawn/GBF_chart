...
fileOperation.copy = function(id, tp){
	...
	function move_copy_click(type){
        ...
        /*
         Emmmm 别念了别念了,师傅我头疼.
         虽然伤害公式看起来很复杂,但其实受武器盘影响能反应到武器上,也就是武器白值,技能武器类型,武器技能这么几项.
         碧蓝幻想中武器拥有的技能多种多样,但基本上可以分为三大类,带M或者@的方阵系列技能,带EX的普刃系列技能,以及带EX的特殊武器技能.
         这方阵系列的武器可以受到方阵召唤石加护,普刃系列的武器可以受到老王召唤的加护,
